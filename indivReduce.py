...
def run():
	...
	while True:
		...
		print "9. Rectify your arc images using the PySALT wavelength solution."
		print "10. Rectify your science images using the PySALT wavelength solution."
		print "11. Rectify your standard star images using the PySALT wavelength solution."
		print "12. Background-subtract your science images."
		print "13. Extract science spectra."
		print "14. Extract standard star spectra."
		print "15. Extract arc spectra."
		print "16. Extract 'true' sky and sigma spectra from non-background-subtracted science images."
		print "17. Identify (and Reidentify) lines in your arc spectra for a second wavelength solution." # runs reidentify function too
		print "18. Dispersion-correct your science spectra using the second wavelength solution."
		print "19. Dispersion-correct your standard star spectra using the second wavelength solution."
		print "20. Create bad wavelength masks for dispersion-corrected science (and perhaps standard star) spectra."
		print "21. Flux-calibrate your science and standard star spectra."
		print "22. Sigma-clip science and standard star spectra."
		print "23. Scale your flux-calibrated science spectra to similar flux values at overlapping wavelengths."
		print "24. Scale your standard star spectra to similar flux values at overlapping wavelengths."
		print "25. Copy sky and sigma spectra from flux-calibrated spectra to different spectral files."
		print "26. Scale your dispersion-corrected science spectra to similar count values at overlapping wavelengths."
		print "27. Combine your dispersion-corrected and flux-calibrated science and standard star spectra."
		print "28. Clean combined science and standard star spectra of leftover chip gaps and highly deviant pixels."
		print "29. Telluric-correct combined science spectrum."
		print "30. Return to the main menu."
		...
		if choice == '0': # show 'RUIMGTYP' and 'RUPIPE' for each file that has them
			...
			print "Here are the global dictionaries of flat-fielded arc images indexed by GR-ANGLE:"
			print dicts.flatarcs
			while True:
		...
		elif choice=='9': # use specrectify on flatarcs with their specidentify solution
			print "You have chosen to rectify flat-fielded arcs with their PySALT wavelength solution."
			if dicts.wavesols == {}:
			...
			print dicts.flatarcs
			while True:
				gratingangle = raw_input("Please enter the GR-ANGLE keyword of the arc you wish to run specrectify on: ")
				angles = dicts.flatarcs.keys()
				if gratingangle not in angles: # angles[i] is already a string, not a double/float
					print "Invalid input: that number is not one of the GR-ANGLE keywords for the dictionary of flat arcs."
				else:
			...
			if anglewavesol == '':  # check if wavelength solution (.db file) for this angle exists
				print "There is no PySALT wavelength solution for this flat arc's angle: "
				print dicts.wavesols
				...
				anglewavearc = dicts.wavearcs.get(gratingangle,'')
				if anglewavearc != '':
					print "There is already a rectified arc image for angle "+gratingangle+": "
					print anglewavearc
					print "If you continue, the current rectified arc image for this angle will be replaced with a new one."
					print "An alternative is to work in a cloned directory (using Option 0 from the main menu)."
					while True: 
						moveforward = raw_input("Enter 0 to return to the submenu, or 1 to move forward: ")
						if moveforward == '0' or moveforward == '1':
							...
							print "Invalid input: you must enter either 0 or 1."
					if moveforward == '0':
						print "You chose to return to the submenu instead of replacing the old rectified arc image."
						continue
					os.remove(anglewavearc) # deleting anglewavearc so there are no conflicts
				angleflatarc = dicts.flatarcs[gratingangle] # flat arc with gratingangle
				inputflatarcs = {gratingangle:angleflatarc} # dictionary consisting of only one GR-ANGLE keyword
				inputwavesols = {gratingangle:anglewavesol}
				tasks.wavecalarc(arcimages=inputflatarcs,sols=inputwavesols,indiv=True)
		elif choice=='10': # use specrectify on laxsciences with their specidentify solution
		...
		elif choice=='11': # use specrectify on flatstandards with their specidentify solution
		...
		elif choice=='12': # background-subtract sciences
		...
		elif choice=='13': # extract sciences (only from background-subtracted for now)
		...
		elif choice=='14': # extract standard stars (only from rectified for now)
		...
		elif choice=='15': # extract arcs (only from rectified for now) -- extracts twice (for sci and for std)
		...
		elif choice=='16': # extract non-background subtracted science spectra
		...
		elif choice=='17': # identify (and reidentify) lines in extracted arcs (both sci and std)
		...
		elif choice=='18': # dispersion-correct science spectra with second wavelength solution
		...
		elif choice=='19': # dispersion-correct standard star spectra with second wavelength solution
		...
		elif choice=='20': # create bad wavelength masks for all dispersion-corrected science and standard star spectra
		...
		elif choice=='21': # flux-calibrate dispersion-corrected science and standard star spectra
		...
		elif choice=='22': # sigma-clip science and standard star spectra
		...
		elif choice=='23': # scale flux science spectra across all gr-angles
		...
		elif choice=='24': # scale standard star spectra across all gr-angles
		...
		elif choice=='25': # copy the sky and sigma spectral bands (3 and 4) of flux-cal science spectra into separate fits files
		...
		elif choice=='26': # scale disp science spectra across all gr-angles
		...
		elif choice=='27': # odcombine dispsciences and fluxsciences (separately)
		...
		elif choice=='28': # clean combined sci and standard star spectra
		...
		elif choice=='29': # telluric-correct combined sci and standard star spectra
